...
class ColumnModel:
    def __init__(self, col_name: str, data_type: dt, rand_data_info: dt.RandomDataTypes, is_pk: bool = False,
                 max_occurences: int = None, not_null: bool = True, is_fk: bool = False, fk_model: ForeignKeyModel = None):
        self.name = col_name
        ...
        self.limit_occurences = (lambda: False if max_occurences is None else True)()
